...
public class LoginActivity extends AppCompatActivity
{
    ...
    String name_str, age_str, sex;
    double lat, lon;
    String lat_s, lon_s;
    //GPSTracker gps;
    //int a; // acts as a flag for male-female

    SessionManager name_age_sex_session;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        //a = 0; // 1- male, 2 - female
        name_age_sex_session = new SessionManager(getApplicationContext());
                        ...
                        else
                        {
                            ...
                            alertDialog.setPositiveButton("Accept", new DialogInterface.OnClickListener()
                            {
                                public void onClick(DialogInterface dialog, int which)
                                {
                                    ...
                                    // Name and (sex+age) details are stored in SessionManager Class (object name: name_age_sex_session)
                                    name_age_sex_session.createLoginSession(name_str, sex, age_str);
