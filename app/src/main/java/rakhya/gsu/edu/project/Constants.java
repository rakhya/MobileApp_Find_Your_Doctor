...
public class Constants {
    ...
    public static final String BETTER_DOCTOR_INSURANCE_QUERY_PARAMETER = "insurance_uid";
    public static final String BETTER_DOCTOR_API_KEY_QUERY_PARAMETER = "user_key";
